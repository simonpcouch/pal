...
* Type in a helper "role." Once it's autocompleted, press Enter.
...
Pals are interfaced with the via the chores addin. For easiest access, we recommend registering the chores addin to a keyboard shortcut.
